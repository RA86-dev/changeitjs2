...
console.clear()
    ...
    function detectWeather(printbool) {
        let lon;
        let lat;
        const kelvin = 273;
        ...
        function handleSuccess(position) {
          ...
          fetch(apiUrl)
            ...
            .then(data => {
              ...
              let tempmax = Math.floor(data.main.temp_max - kelvin) + "C";
              let tempmin = Math.floor(data.main.temp_min - kelvin) + "C";
              ...
              console.log('Temperature Minimum: ' + tempmin)
